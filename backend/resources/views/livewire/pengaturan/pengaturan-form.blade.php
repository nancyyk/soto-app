        ...
        <div class="p-6 space-y-8">
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        @error("depotNama") <p class="text-xs text-red-500  mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="form-label">Latitude</label>
                            <input wire:model="depotLat" type="number" step="0.0001" class="form-input font-mono" />
                            @error("depotLat") <p class="text-xs text-red-500  mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="form-label">Longitude</label>
                            <input wire:model="depotLng" type="number" step="0.0001" class="form-input font-mono" />
                            @error("depotLng") <p class="text-xs text-red-500  mt-1">{{ $message }}</p> @enderror
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400  mt-1">Node yang kapasitasnya mencapai persentase ini akan masuk dalam kalkulasi rute TSP.</p>
                    @error("tspThreshold") <p class="text-xs text-red-500  mt-1">{{ $message }}</p> @enderror
                </div>
            </div>
