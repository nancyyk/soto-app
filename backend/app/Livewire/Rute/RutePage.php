...
class RutePage extends Component
{
    ...
    public function loadData(): void
    {
        ...
        $depot = [
            "lat"  => (float) \App\Models\Setting::get("depot_lat", -7.275),
            "lng"  => (float) \App\Models\Setting::get("depot_lng", 112.790),
            "nama" => \App\Models\Setting::get("depot_nama", "Pos Pengangkutan"),
        ];
